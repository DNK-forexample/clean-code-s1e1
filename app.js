...
var incompleteTaskHolder = document.querySelector(".todo-section__list"); //ul of #incompleteTasks
...
var createNewTaskElement = function (taskString) {
  ...
  editButton.className = "list-item__edit-button";

  deleteButton.className = "list-item__delete-button";
...
var bindTaskEvents = function (taskListItem, checkBoxEventHandler) {
  ...
  var editButton = taskListItem.querySelector("button.list-item__edit-button");
  var deleteButton = taskListItem.querySelector(
    "button.list-item__delete-button"
  );
